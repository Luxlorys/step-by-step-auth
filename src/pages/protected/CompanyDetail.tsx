...
import { mockJoinRequests } from "@/data/mockJoinRequests";
...
const CompanyDetails = () => {
  ...
  const member = mockJoinRequests.find(req => req.id === parseInt(id || ""));
  ...
  return (
    <div className="h-full">
      <div className="h-full">
        ...
        {/* Action Buttons */}
        <div className="fixed bottom-12 right-12 flex gap-3 z-10">
          <Button 
            variant="outline" 
