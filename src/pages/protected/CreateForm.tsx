  ...
  return (
    <div className="p-6">
      <div className="border border-[#E2E8F0] rounded-lg p-6">
        ...
        {fields.length === 0 ? (
          <div className="h-[170px] bg-[#F8F8F8] border-2 border-[#D1D5DB] border-dashed rounded-lg flex flex-col items-center justify-center mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6 border border-dashed rounded-lg p-2">
            {fields.map((field) => (
