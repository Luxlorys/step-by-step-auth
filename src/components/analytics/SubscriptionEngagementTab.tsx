      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
              ...
              <CardTitle className="text-md font-medium text-gray-950 flex items-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>
                        Displays the total number of subscriptions during the
                        selected period
                      </p>
                    </TooltipContent>
                  </Tooltip>
          ...
          <CardContent className="px-0 pb-0">
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-md text-green-600">
                  {newSubscriptions.toLocaleString()}
                </span>
                <div className="text-md text-green-600 flex items-center gap-1">
                  +{newSubsChange}% ↗
                </div>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-md font-medium">Unsubscribes</span>
        ...
        <Card className="p-3 bg-[#FCFCFC] border-[#E5E6E8]">
          ...
          <CardContent className="px-0 pb-0">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-md font-medium">Sent</span>
                <span className="text-md text-green-600">
                  {invitationsSent.toLocaleString()}
                </span>
                <div className="text-md text-green-600 flex items-center gap-1">
                  +{invitationsChange}% ↗
                </div>
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-md font-medium">Accepted</span>
                <span className="text-md text-green-600">
                  {invitationsAccepted.toLocaleString()}
                </span>
                <div className="text-md text-green-600 flex items-center gap-1">
                +{acceptedChange}% ↗
              </div>
